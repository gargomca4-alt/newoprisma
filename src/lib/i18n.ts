...
const resources = {
  fr: {
    translation: {
      ...
      nav: { calculator: "Calculateur", products: "Produits", paper: "Papiers", print: "Impression", finitions: "Finitions", quotes: "Devis", clients: "Clients", payment: "Paiements", settings: "Paramètres" },
  ...
  ar: {
    translation: {
      ...
      nav: { calculator: "الحاسبة", products: "المنتجات", paper: "الورق", print: "الطباعة", finitions: "التشطيبات", quotes: "العروض", clients: "العملاء", payment: "المدفوعات", settings: "الإعدادات" },
  ...
  en: {
    translation: {
      ...
      nav: { calculator: "Calculator", products: "Products", paper: "Paper", print: "Print", finitions: "Finitions", quotes: "Quotes", clients: "Clients", payment: "Payments", settings: "Settings" },
